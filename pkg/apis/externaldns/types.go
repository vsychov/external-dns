...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("txt-encryption-key", "When using the TXT registry, an encryption key, that will be used for encrypt TXT records (default: encryption disabled)").Default(defaultConfig.TXTEncryptionKey).StringVar(&cfg.TXTEncryptionKey)
